...
trainingExprData=as.matrix(read.table('C:/Users/danie/OneDrive/Desktop//train data/GDSC_Expression_Matrix.txt', header=TRUE, row.names=1))
dim(trainingExprData) #17419 257 
#Read in GDSC training response data. rownames() are samples (cosmic ids), colnames() are drugs.
trainingPtype=as.matrix(read.table('C:/Users/danie/OneDrive/Desktop/train data/GDSC_Response_Matrix.txt', header=TRUE, row.names=1))
...
trainingExprData=as.matrix(read.table('C:/Users/danie/OneDrive/Desktop/train data/CTRP_Expression_Matrix.txt', header=TRUE, row.names=1))
...
trainingPtype=as.matrix(read.table('C:/Users/danie/OneDrive/Desktop/train data/CTRP_Response_Matrix.txt', header=TRUE, row.names=1))
