...
data$Tumor_Sample_Barcode<-substr(samps,1,nchar(samps)-12)
...
#Apply test()
#This function wil export the files MutationTestOutput_pVal.txt and #MutationTestOutput_betaVal.txt
#The files contain p-values and beta-values (effect sizes) for each drug-gene association, respectively. 
