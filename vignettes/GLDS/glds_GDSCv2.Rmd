...
dim(trainingPtype) #805 198 ...there are some NA values so prcomp() will complain when you apply the GLDS function.
...
#The sensitivity data used here is GDSCv2 (805 cell lines x 198 drugs).

#Read GDSC's updated cell line information file.
library(readxl)
...
drugMat<-cm #Finally, set this object as the drugMat parameter. 
