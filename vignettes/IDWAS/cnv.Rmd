---
title: "Download CNV data from GDC, then apply map_cnv() and idwas()"
...
```{r}
#BiocManager::install(c("TxDb.Hsapiens.UCSC.hg19.knownGene", "org.Hs.eg.db", "GenomicFeatures", maftools))
