---
title: "Download somatic mutation data from GDC, then apply idwas()"
...
data$Tumor_Sample_Barcode<-substr(samps,1,nchar(samps)-12) #Make sure these sample ids are of the same form as your the sample ids in your prediction data.
